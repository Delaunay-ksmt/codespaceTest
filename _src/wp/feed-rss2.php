...
<rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:wfw="http://wellformedweb.org/CommentAPI/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:sy="http://purl.org/rss/1.0/modules/syndication/" xmlns:slash="http://purl.org/rss/1.0/modules/slash/" <?php
	...
	<channel>
		<title><?php echo get_field('siteinfo','option')['sitetitle']; ?></title>
		<atom:link href="<?php self_link(); ?>" rel="self" type="application/rss+xml" />
		<link><?php bloginfo_rss('url') ?></link>
		<description><?php echo get_field('meta','option')['description']; ?></description>
		<lastBuildDate><?php
	...
	?>
		<item>
			...
			<description>
				<![CDATA[<?php echo strip_tags(get_field('lead',$post_id)); ?>]]>
			</description>
			<content:encoded>
				<![CDATA[<?php echo get_field('body',$post_id); ?>]]>
			</content:encoded>
			<image>
				<url><?php echo get_field('mv',$post_id)['url']; ?></url>
			</image>
