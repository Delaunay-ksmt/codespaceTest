					...
					<ul class="<?php echo $class; ?>">
						<?php foreach ($this_page_value['child'] as $list) { ?>
							<li class="<?php echo $class . '__li'; ?>">
								<div class="<?php echo $class . '__wrap'; ?>">
									<a href="<?php echo $list['link']['url']; ?>" class="<?php echo $class; ?>__img__wrap">
										<?php //echo $image->getHtml($class . '__img', true, 'large');
										?>
									</a>
									<?php if ($list['category']) : ?>
										<div class="<?php echo $class; ?>__category">
											<?php setHtmlTaxonomy($list['category'], false); ?>
										</div>
									<?php endif; ?>
									<div class="<?php echo $class; ?>__txtwrap">
										<a href="<?php echo $list['link']['url']; ?>">
											...
											<h3 class="<?php echo $class; ?>__ttl"><span><?php echo $list['title']['title']; ?></span></h3>
											<p class="<?php echo $class; ?>__lead"><span><?php echo $list['title']['lead']; ?></span></p>
										</a>
										<?php if ($list['tag']) : ?>
											<div class="b-column__tag">
												<?php setHtmlTaxonomy($list['tag'], false); ?>
											</div>
										<?php endif; ?>
									</div>
								</div>
